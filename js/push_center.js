...
$(function () {
    ...
    $("#timeFive").change(function () {
        $(".act-end-t3").find("span").html("").html("送货日期&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + $(this).val());
    });
...
/*获取屏幕高度*/
function moveDefault(event) {
    event.preventDefault();
}
function popBg() {
    var domHg = $(window).height();
    $(".check-pop").css("height", domHg).css("display", "block");
    $("html").get(0).removeEventListener("touchmove",function(event){event.preventDefault()},false);
}
